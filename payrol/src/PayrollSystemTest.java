...
abstract class EmployeeBase
    ...
    public String toString() {
        ...
        return String
                .format(" Employee ID: %s Level : %s Salary : %.2f", ID,
...
class HourlyEmployee extends EmployeeBase {
    ...
    public String toString() {
        return super.toString() + String.format(
                " Regular hours : %.2f Overtime hours : %.2f", regular,
                overtime);
    }
}
...
class PercentageBonusDecorator extends BonusDecorator {
    ...
    public PercentageBonusDecorator(Employee employee,
                                    double percent) {
        super(employee);
...
class PayrollSystem {
    ...
    void printStatisticsForOvertimeSalary() {
        ...
        System.out
                .printf(" Statistics for overtime salary : Min: %.2f " +
                                " Average : %.2f Max: %.2 f Sum: %.2f",
